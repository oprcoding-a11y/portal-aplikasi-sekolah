...
url:
  "https://script.google.com/macros/s/AKfycbwCJZloVcG2M155_J4dAfQGwZJIdo6ZY7_5Y_RZfBJGRHj6WtdeyiP39KrJoplxTjdzBg/exec",
...
url:
  "https://script.google.com/macros/s/AKfycbxWvRXU_64WQxEoUr_YXinBp6rosKZ3pgmysM8S3OXpFSJyZxcaTRk2BMCJE_Felofl3g/exec",
...
const accessIcon = app.requiresLogin
  ? (currentUser && hasApplicationAccess(app) ? "fa-lock-open" : "fa-lock")
  : "fa-globe";
const accessTitle = !app.requiresLogin
  ? "Akses publik"
  : !currentUser
    ? "Perlu login untuk mengakses aplikasi"
    : hasApplicationAccess(app)
      ? "Akses diizinkan"
      : "Akses terbatas untuk role ini";
...
<article class="application-card">
  <div class="card-top">
    ...
    <div class="card-badges">
      ...
      <span class="access-badge ${accessClass}" title="${accessTitle}" aria-label="${accessTitle}">
        <i class="fa-solid ${accessIcon}" aria-hidden="true"></i>
      </span>
    </div>
  </div>
